	...
	#+begin_src emacs-lisp
	  (setq org-tag-alist
			'(("@career"         . ?c) ; personal professional development (different than learn?)
			  ...
			  ("@life"           . ?i) ; life event planning and maintenance work
...
*** Sprint Work
	...
	I no longer use this as an engineering manager, however keep it around for historical purposes. It is not exported
	from my org config.
