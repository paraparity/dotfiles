...
* Org-Mode Configuration
  Org-mode is probably my biggest anchor to Emacs. I've tried org-mode-like plugins for other editors and IDE's, but
  nothing compares to the real thing. Enshrined within this section is my configuration and customization of Emacs
  org-mode.
...
** Capture Templates
   ...
   literate config to better describe each part. First we must set up this list.
   ...
   #+begin_src emacs-lisp
	 ...
	 (add-to-list 'org-capture-templates
				  '("sd" "Development Task" entry (file+olp "~/org/agendas/organizer.org" "Current Sprint" "Development")
					"* TODO [#A] %? :TASK:\n"))
	 (add-to-list 'org-capture-templates
				  '("sv" "Review Task" entry (file+olp "~/org/agendas/organizer.org" "Current Sprint" "Review")
					"* TODO [#A] %? :TASK:\n"))
	 (add-to-list 'org-capture-templates
				  '("sr" "Research Task" entry (file+olp "~/org/agendas/organizer.org" "Current Sprint" "Research")
					"* TODO [#A] RESEARCH: %? :TASK:\n"))
	 (add-to-list 'org-capture-templates
				  '("ss" "Spike Task" entry (file+olp "~/org/agendas/organizer.org" "Current Sprint" "Research")
					"* TODO [#A] SPIKE: %? :TASK:\n"))
	 (add-to-list 'org-capture-templates
				  '("so" "Other Task" entry (file+olp "~/org/agendas/organizer.org" "Current Sprint" "Other")
					"* TODO [#A] %? :TASK:\n"))
   #+end_src
   ...
   #+begin_src emacs-lisp
	 ...
	 (add-to-list 'org-capture-templates
				  '("rk" "Kudos" item (file+olp "~/org/agendas/retrospective.org" "Capture" "Kudos")
					"- %?" :empty-lines 1))
	 (add-to-list 'org-capture-templates
				  '("rg" "Goodness" item (file+olp "~/org/agendas/retrospective.org" "Capture" "Goodness")
					"- %?" :empty-lines 1))
	 (add-to-list 'org-capture-templates
				  '("rb" "Badness" item (file+olp "~/org/agendas/retrospective.org" "Capture" "Badness")
					"- %?" :empty-lines 1))
	 (add-to-list 'org-capture-templates
				  '("rz" "Kaizen" item (file+olp "~/org/agendas/retrospective.org" "Capture" "Kaizen")
					"- %?" :empty-lines 1))
   #+end_src

   This capture group is for non-sprint related tasks, which should each go to their propper group and have a default
   priority based on how I typically file similar tasks. These can easily be adjusted up or down via the agenda view, so
   it's perfectly fine for them to be innaccurate for the task, as long as they're typically correct.
   ...
   #+begin_src emacs-lisp
	 ...
	 (add-to-list 'org-capture-templates
				  '("tc" "Career Task" entry (file+headline "~/org/agendas/organizer.org" "Career")
					"* TODO [#B] %? :TASK:\n"))
	 (add-to-list 'org-capture-templates
				  '("tg" "Guild Task" entry (file+headline "~/org/agendas/organizer.org" "Guild")
					"* TODO [#C] %? :TASK:\n"))
	 (add-to-list 'org-capture-templates
				  '("to" "Office Task" entry (file+headline "~/org/agendas/organizer.org" "Office")
					"* TODO [#B] %? :TASK:\n"))
	 (add-to-list 'org-capture-templates
				  '("tw" "Workstation Task" entry (file+headline "~/org/agendas/organizer.org" "Workstation")
					"* TODO [#C] %? :TASK:\n"))
	 (add-to-list 'org-capture-templates
				  '("tt" "General Task" entry (file+headline "~/org/agendas/organizer.org" "Tasks")
					"\n* TODO [#C] %? :TASK:\n %i\n %a\n\n"))
   #+end_src
   ...
   #+begin_src emacs-lisp
	 ...
	 (add-to-list 'org-capture-templates
				  '("mm" "Pop Up Meetings and One-Offs" entry (file+olp "~/org/agendas/tickler.org" "Meetings" "One Offs")
					"* TODO %?\n"))
   #+end_src
   ...
   #+begin_src emacs-lisp
	 ...
	 (add-to-list 'org-capture-templates
				  `("n" "Note" entry (file+headline "~/org/agendas/inbox.org" "Notes Capture")
					"* %?\n %i\n See: %a" :empty-lines 1))
	 (add-to-list 'org-capture-templates
				  `("m" "Manager Notes" item (file+olp "~/org/agendas/manager.org" "1:1 Prep" "Capture")
					"- %?" :empty-lines 1))
	 (add-to-list 'org-capture-templates
...
** TODO PDF-Tools
   ...
   Unfortunately my current config has trouble doing a fresh install as this has a dependency on pdf-tools being
