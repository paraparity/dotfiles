...
*** Manage Modeline Modes with =diminish= and =delight=
=diminish= allows us to hide modeline mode names and =delight= allows us to change their appearance using lisp. We can use these
to alias, hide, or even programmatically define modeline mode indicators.
...
In general I use screns that aren't limited to 80 characters width. I'd prefer to take advantage of that width and have
...
** TODO Configuration Reading [0/11]
